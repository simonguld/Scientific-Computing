...
for w in omega_values:
    ...
    #extrema corresponds to w-omega_uncertainty, w and w+omega_uncertainty
...
print(f'We note that the polarizability has a singularity at omega_singularity = {omega_singularity} due to the very near singularity of'
      ...
      f' {condition_number_inf(E-omega_singularity*S):.1e}. Specifically, it is due to the fact that the last'
      f' diagonal element of the matrix A at this frenquency is of the order of e-3, as is explained in more detail'
      f' in the rapport')
plt.show()
